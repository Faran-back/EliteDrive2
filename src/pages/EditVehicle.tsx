...
const EditVehicle: React.FC = () => {
  ...
  // Gallery state and refs for 4 additional images (total 5 images with primary)
  ...
  useEffect(() => {
    ...
    if (foundVehicle) {
      ...
      if (!isInitialized) {
        ...
        // Populate gallery from stored images or default to at least 4 items
        if (foundVehicle.images) {
          const loaded = [...foundVehicle.images];
                  ...
                  <div className="relative group aspect-[4/3] rounded-2xl overflow-hidden bg-slate-50 border border-dashed border-slate-200 hover:border-blue-300 transition-all">
                    {gallery[idx] ? (
                      <>
                        ...
                        />
                        <div className="absolute inset-0 bg-black/50 opacity-0 group-hover:opacity-100 transition-all flex items-center justify-center gap-1.5 flex-wrap p-1">
                          <button
                            type="button"
                            onClick={() => {
                              setActiveSlot(idx);
                            ...
                            className="p-1 px-1.5 text-[9px] font-black uppercase tracking-widest bg-white text-blue-600 rounded-lg hover:bg-slate-50 shadow-sm flex items-center justify-center"
                          >
                            Change
                          </button>
                          <button
                            ...
                            className="p-1 px-1.5 text-[9px] font-black uppercase tracking-widest bg-red-600 text-white rounded-lg hover:bg-red-700 shadow-sm flex items-center justify-center"
                          >
                            Remove
                          </button>
                        </div>
